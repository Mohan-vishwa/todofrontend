...
function Signup() {
  ...
  const signup = async (username, password) => {
    ...
    const response = await fetch(
      "https://todobackend-s1o5.onrender.com/register",
      {
        method: "POST",
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-green-200 rounded-xl shadow-lg border border-orange-200">
      ...
      >
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-green-500 hover:bg-blue-600 text-white font-bold rounded w-full transition-colors duration-200"
